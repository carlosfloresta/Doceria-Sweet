...
import LojaVirtual.Administrador.MenuAdm;
...
public class Tela_principalAdm extends JFrame implements ActionListener {

    private static final long serialVersionUID = 1L;
    private JLabel limage, l_menu, l_descricao, l_altcliente, l_altprodut,
            l_altforn, Label_hora;
    ...
    public Tela_principalAdm() {
        ...
        Label_hora = new JLabel(" Hora do sistema: " + formattedDate);
        ...
        JButton usuarios = new JButton("Usuarios do Sistema");
        ...
        l_altforn = new JLabel("Alt+F = Usuarios do Sistema ");
...
//        TROCAR CAMINHO DA IMAGEM
        bt_cardapio = new JButton("Usuarios do Sistema", new ImageIcon("C:\\Users\\Carlos Henrique\\Documents\\NetBeansProjects\\teste\\src\\LojaVirtual\\Imagens\\cardapio.png"));
        ...
        bt_cardapio.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                MenuAdm menu;
                menu = new MenuAdm();
                menu.setNome(l_descricao.getText());
                desktop.add(menu);
        ...
        home.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent arg0) {
                Tela_principalAdm show = new Tela_principalAdm();
